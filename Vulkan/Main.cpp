...
private:
    ...
    void createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load("texture/brickwall.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    void createnormalTextureImage() {
        int texWidth, texHeight, texChannels;
        stbi_uc* pixels = stbi_load("texture/brickwall_normal.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
        VkDeviceSize imageSize = texWidth * texHeight * 4;
        ...
        createImage(texWidth, texHeight, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, normalImage, normalImageMemory);

        transitionImageLayout(normalImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL);
        copyBufferToImage(stagingBuffer, normalImage, static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight));
        transitionImageLayout(normalImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.lightPos = glm::vec3(0.0, 0.0f, 1.0f);
        ubo.proj[1][1] *= -1;
